...
# Installs C++ toolchain and dependencies (CPU-only, no CUDA)
...
# CPU-only configuration for ppc64le
# Using VSX SIMD instructions (Power Vector/Scalar eXtensions)
